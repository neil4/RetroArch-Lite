...
static const struct retro_keybind retro_keybinds_1[] = {
   ...
   { true, RARCH_JOYPAD_DPAD_AREA,        RETRO_LBL_DPAD_AREA,             RETROK_UNKNOWN, NO_BTN, 0, AXIS_NONE },
   { true, RARCH_JOYPAD_ABXY_AREA,        RETRO_LBL_ABXY_AREA,             RETROK_UNKNOWN, NO_BTN, 0, AXIS_NONE },
   ...
   { true, RARCH_MOVIE_RECORD_TOGGLE,     RETRO_LBL_MOVIE_RECORD_TOGGLE,   RETROK_UNKNOWN, NO_BTN, 0, AXIS_NONE },
