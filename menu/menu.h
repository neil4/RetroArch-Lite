...
#define MENU_SETTINGS_CORE_HISTORY_NONE 0xffff
#define MENU_SETTINGS_CORE_OPTION_START 0x10000

#define MENU_KEYBOARD_BIND_TIMEOUT_SECONDS 4
...
typedef enum
{
   ...
   MENU_SETTINGS_LIBRETRO_DEVICE_INDEX_BEGIN,
   MENU_SETTINGS_LIBRETRO_DEVICE_INDEX_END = MENU_SETTINGS_LIBRETRO_DEVICE_INDEX_BEGIN + (MAX_USERS - 1),
   MENU_SETTINGS_INPUT_JOYKBD_LIST_BEGIN,
   MENU_SETTINGS_INPUT_JOYKBD_LIST_END = MENU_SETTINGS_INPUT_JOYKBD_LIST_BEGIN + (JOYKBD_LIST_LEN - 1),
} menu_settings_t;
