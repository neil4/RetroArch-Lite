...
enum setting_list_flags
{
   ...
   SL_FLAG_ALL_TOP                  =  (1 << 25),
   SL_FLAG_OVERLAY_KEYBOARD_OPTIONS =  (1 << 26),
   SL_FLAG_OVERLAY_MOUSE_OPTIONS    =  (1 << 27),
   SL_FLAG_OVERLAY_LIGHTGUN_OPTIONS =  (1 << 28),
   SL_FLAG_MENU_VISIBILITY_OPTIONS  =  (1 << 29),
   SL_FLAG_ALL                      =  (1 << 30)
};
