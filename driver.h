...
#define RARCH_FIRST_META_KEY RARCH_LIGHTGUN_BIND_LIST_END
...
#define META_KEY_MASK \
   ...
   | UINT64_C(1) << RARCH_SHOW_FPS_TOGGLE \
   ...
   | UINT64_C(1) << RARCH_ADVANCED_TOGGLE \
